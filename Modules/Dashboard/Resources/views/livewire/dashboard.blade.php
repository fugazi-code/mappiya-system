<div>
    ...
    {{-- <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <p class="card-title">Order Statistics</p>
                    <div class="col-md-12 grid-margin transparent mb-0">
                        <div class="row">
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <p class="card-title">System Statistics</p>
                    <div class="col-md-12 grid-margin transparent mb-0">
                        <div class="row">
                            <div class="col-md-3 stretch-card transparent">
                                <div class="card card-tale">
                            ...
                            <div class="col-md-3 stretch-card transparent">
                                <div class="card card-dark-blue">
                                    <div class="card-body">
                                        <p class="mb-4">Delivery People</p>
                                        <p class="fs-30 mb-2">61344</p>
                                        <p>22.00% (30 days)</p>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 stretch-card grid-margin grid-margin-md-0">
                    <div class="card data-icon-card-primary">
                        <div class="card-body">
                            <p class="card-title text-white">Number of Cancelled Orders</p>
                            <div class="row">
